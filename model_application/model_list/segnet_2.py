...
def segnet_resnet_v1(input_shape, batch_size, n_labels=2, kernel=3, pool_size=(2, 2), output_mode="softmax",
                     model_summary=None):
    # encoder
    ...
    conv_2 = conv_block_3(input_tensor=pool_1, kernel_size=(kernel, kernel), filters=[128, 128, 128], stage=2,
                          block='a')
    pool_2, mask_2 = MaxPoolingWithArgmax2D(pool_size)(conv_2)
    conv_3 = conv_block_3(input_tensor=pool_2, kernel_size=(kernel, kernel), filters=[128, 128, 128], stage=3,
                          block='a')
    pool_3, mask_3 = MaxPoolingWithArgmax2D(pool_size)(conv_3)
    conv_4 = conv_block_3(input_tensor=pool_3, kernel_size=(kernel, kernel), filters=[256, 256, 256], stage=4,
                          block='a')
    pool_4, mask_4 = MaxPoolingWithArgmax2D(pool_size)(conv_4)
    conv_5 = conv_block_3(input_tensor=pool_4, kernel_size=(kernel, kernel), filters=[256, 256, 256], stage=5,
                          block='a')
    ...
    conv_6 = identity_block_3(input_tensor=unpool_1, kernel_size=(kernel, kernel), filters=[256, 256, 256], stage=6,
                              block='a', next_layer_filter=256)
    unpool_2 = MaxUnpooling2D(pool_size)([conv_6, mask_4])
    conv_7 = identity_block_3(input_tensor=unpool_2, kernel_size=(kernel, kernel), filters=[256, 256, 256], stage=7,
                              block='a', next_layer_filter=128)
    unpool_3 = MaxUnpooling2D(pool_size)([conv_7, mask_3])
    conv_8 = identity_block_3(input_tensor=unpool_3, kernel_size=(kernel, kernel), filters=[128, 128, 128], stage=8,
                              block='a', next_layer_filter=128)
    unpool_4 = MaxUnpooling2D(pool_size)([conv_8, mask_2])
    conv_9 = identity_block_3(input_tensor=unpool_4, kernel_size=(kernel, kernel), filters=[128, 128, 128], stage=9,
                              block='a', next_layer_filter=64)
    unpool_5 = MaxUnpooling2D(pool_size)([conv_9, mask_1])
    conv_10 = identity_block_3(input_tensor=unpool_5, kernel_size=(kernel, kernel), filters=[64, 64, 64], stage=10,
                               block='a', next_layer_filter=64)
